...
class ChineseRegionalCollector:
    def __init__(self):
        ...
        self.chinese_keywords = [
            '中華', '中華料理', '中国料理', '中華レストラン', '中国菜',
            '四川料理', '広東料理', '北京料理', '上海料理', '湖南料理',
            '山東料理', '江蘇料理', '浙江料理', '福建料理', '本格中華',
            '町中華', '街の中華', '老舗中華', '家庭中華', '餃子',
            'ラーメン', '麻婆豆腐', '回鍋肉', '青椒肉絲', '酢豚',
            'チャーハン', '炒飯', '点心', '飲茶', 'Chinese restaurant'
        ]
    ...
    def collect_region(self, region, target_count=100):
        ...
        print(f"📊 {region} 中華収集完了: {collected}件")
        return collected

    def run_full_chinese_collection(self):
        """全地域中華データ収集実行"""
        print("🥢 中華ジャンル全国収集システム")
        print("=" * 70)
        print("📊 目標: 7地域 × 最大100件 = 最大700件")
        print("📋 ジャンル: gourmet_chinese")
        print("=" * 70)
...
if __name__ == "__main__":
    ...
    collector = ChineseRegionalCollector()
    ...
    if len(sys.argv) > 1:
        ...
        # 全地域収集
        collector.run_full_chinese_collection()
