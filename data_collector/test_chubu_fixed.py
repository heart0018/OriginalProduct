...
class ChubuRelaxDataCollectorFixed:
    def __init__(self):
        """初期化"""
    ...
    def collect_onsen_test(self):
        ...
        try:
            ...
            for query in test_queries:
                ...
                for result in search_results[:2]:  # 各クエリから最大2件
                    ...
                    if place_id:
                        ...
                        if detailed_place:
                            ...
                            if any(pref in address for pref in self.chubu_prefectures):
            ...
            # データベースに保存
            if unique_places:
                saved_count = self._save_to_database(connection, unique_places, 'relax_onsen_test')
                print(f"\n✅ テスト完了: {saved_count}件保存")
            else:
                print("\n❌ 保存するデータがありません")
...
def main():
    collector = ChubuRelaxDataCollectorFixed()
